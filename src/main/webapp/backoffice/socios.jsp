   ...
   <header class="navbar navbar-expand-md navbar-dark bd-navbar">
    <nav class="container-xxl flex-wrap flex-md-nowrap" aria-label="Main navigation">
          ...
          <div class="navbar-collapse collapse show" id="bdNavbar">
            <ul class="navbar-nav flex-row flex-wrap bd-navbar-nav pt-2 py-md-0">
              ...
              <c:if test="${usuario_logeado.administrador == true }">
	              <li class="nav-item col-6 col-md-auto">
	                <a class="nav-link p-2 active" href="backoffice/SociosListarController">Socios</a>
	              </li>
	              <li class="nav-item col-6 col-md-auto">
      ...
      <main class="container">
        ...
        <br>
        <a href="backoffice/SociosEditarController?id=0&formularioAlta.jsp">Añadir Nuevo Socio</a>
        <br><br>
      ...
      <table class="table table-striped table-hover">
        ...
        <c:forEach var="sIteracion" items="${socios}">
	          <tr>
	            ...
	            <td><a href="backoffice/SociosEditarController?id=${sIteracion.id}&formularioAlta.jsp" class="btn btn-primary">Editar</a></td>
 	            <td><a href="backoffice/SociosEliminarController?id=${sIteracion.id}" onclick="confirmarEliminacion('${sIteracion.nombre}')"  class="btn btn-danger">Eliminar</a></td>
	          </tr>
	         </c:forEach> 
